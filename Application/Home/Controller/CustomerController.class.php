...
class CustomerController extends HomeController {
	...
	function export() {
		...
		$objPHPExcel -> getProperties() -> setCreator("网络民兵指挥管理系统") -> setLastModifiedBy("网络民兵指挥管理系统") -> setTitle("Office 2007 XLSX Test Document") -> setSubject("Office 2007 XLSX Test Document") -> setDescription("Test document for Office 2007 XLSX, generated using PHP classes.") -> setKeywords("office 2007 openxml php") -> setCategory("Test result file");
		// Add some data
		$i = 1;
		//dump($list);
		foreach ($list as $val) {
