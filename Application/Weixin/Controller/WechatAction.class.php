...
class WechatAction extends Action {
				...
				switch ($data ['Content']) {
					...
					default :
						...
						if (strpos ( $data ['Content'], '任务' ) !== false) {
							...
							$reply = array ( '欢迎使用　网络民兵指挥管理系统　企业号', 'text'  );
						}
						break;
				}
	...
	public function setmenu(){
		...
		$sub1 = array('type'=>'view','name'=>'管家OA','url'=>$oauth_url);
		$sub2 = array('type'=>'location_select ','name'=>'签到','key'=>'sign_up');
	...
	private function getSubscribe($openid = ''){
		$re = "";
		$re .= "您好，欢迎关注　网络民兵指挥管理系统　企业号。为了让您能方便快捷的使用　网络民兵指挥管理系统　";
		$re .= "请先确认您在　网络民兵指挥管理系统　系统中有帐号，并进行微信号码绑定，绑定后后可以直接进入　网络民兵指挥管理系统　";
		...
		if ($openid && $userid > 0) {
			switch ($taskevent) {
				...
				case 'ites_intro' : // 功能介绍
					$re = "";
					$re .= "您好，欢迎关注　网络民兵指挥管理系统　企业号号。您可以回复以下数字了解您想了解的信息：\n";
					$re .= "1: 任务提醒\n";
					$re .= "2: 查看我申请的任务\n";
					$re .= "3: 查看邀请我的任务\n";
					$re .= "4: 查看待评价的任务\n";
